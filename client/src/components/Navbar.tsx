        ...
        <div className="w-full mx-auto max-w-full">
          <div className="bg-[var(--veblyss-color)] rounded-lg px-6 py-3 flex items-center justify-between shadow-md border border-white/10 h-16 relative">
            ...
            <div className="hidden md:flex items-center gap-4 relative">
              ...
              <Link
                href="https://wa.me/447722184477?text=Hello%2C%20I%27m%20interested%20in%20your%20%5BProduct%20Name%5D%20from%20VeBlyss%20Global.%20Please%20share%20more%20details."
                target="_blank"
                rel="noopener noreferrer"
                className="ml-2"
              >
