export const productsData = {
  ...
  handicrafts: {
    heroSection: {
      ...
      subHeading:
        "Authentic Indian handicrafts — hand-made wooden, metal, terracotta and textile pieces celebrating traditional techniques and sustainable materials.",
    },
    productRangeSections: [
      {
        name: "Wooden décor",
  ...
  "sustainable-products": {
    heroSection: {
      ...
      subHeading:
        "Eco-friendly products crafted from sustainable materials — designed for conscious consumers and businesses seeking low-impact alternatives.",
    },
    productRangeSections: [
      {
